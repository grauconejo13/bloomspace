  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-3 mb-2">
        ...
        <p className="font-heading text-moss/80 text-sm font-medium">
          Bloomspace &copy; {currentYear}
        </p>
        <span className="text-lavender/50 text-xs">✦</span>
      </div>
      <p className="text-moss/80 text-xs mb-3">
        Grow something beautiful, one flower at a time.
      </p>
      <Link
        to="/about#faq"
        className="text-moss/80 hover:text-moss text-xs font-semibold underline-offset-2 hover:underline transition-colors"
      >
        FAQ
      </Link>
    </footer>
